...
public record PaintingResponse(
    ...
    public static PaintingResponse fromPainting(Painting painting){
        return new PaintingResponse(
                ...
                painting.getBibliographySource() == null ? new String[0] : painting.getBibliographySource().split("\n"),
                painting.getBibliographyReference() == null ? new String[0] : painting.getBibliographyReference().split("\n"),
